<template>
  <div class="inner course hci">
    <FeaturedProductList />
    <div class="area pr0">
      <div class="a_top">
        <h2 class="tit">강의 수강자의<br/><b class="txt_point_line">HCI개론(인터렉션디자인 이해)<br/> 결과물</b> 보기</h2>
    ...
    <div class="area">
      ...
      <div class="area_bx_review">
        <div class="bx_review">
          ...
          <p>“이번 수업을 통해 많은 지식을 얻을 수 있었어요. 최고 최고!! 짱짱!! 또 듣고싶습니다!”</p>
          <span>- 3학년 박ㅇㅇ -</span>
        </div>
        <div class="bx_review">
          <div class="scope five">별 다섯개</div>
        ...
        <div class="bx_review">
          <div class="scope five">별 다섯개</div>
          <p>“UX방법론 수업듣고 UX디자이너로 취업 성공! 한성대학교 들어오길 잘했다!!”</p>
          <span>- 3학년 박ㅇㅇ -</span>
        </div>
      </div>
    </div>
    <div class="area">
      <div class="a_top">
        <h2 class="tit">HCI개론(인터렉션디자인 이해) 강의와<br /><b class="txt_point_line">비슷한 강의</b>둘러보기</h2>
      </div>
