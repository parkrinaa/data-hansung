  ...
  <div class="inner course layoutdesign">
    ...
    <div class="area pr0">
      <div class="a_top pb20">
        <h2 class="tit">강의 수강자의<br/><b class="txt_point_line">레이아웃 디자인 결과물</b> 보기</h2>
    ...
    <div class="area">
      ...
      <div class="area_bx_review">
        <div class="bx_review">
          ...
          <p>레이아웃의 중요성 깨닫는 수업입니다^^ 좋은강의 감사합니다</p>
          <div class="t_bottom">
            <div class="b_left">
        ...
        <div class="bx_review">
          ...
          <p>레이아웃 디자인 수업듣고 취업 성공..<br />수업구성이 너무 알차네요^^!</p>
          <div class="t_bottom">
            <div class="b_left">
              <span class="date">{{ today.day }} {{ today.date }}</span> <br/>
            </div>
    ...
    <div class="area">
      <div class="a_top">
        <h2 class="tit">레이아웃 디자인 강의와<br /><b class="txt_point_line">비슷한 강의</b>둘러보기</h2>
      </div>
