<template>
  <div class="inner course information">
    <div id="btn_group">
    ...
    <div class="area">
      ...
      <div class="area_bx_review">
        <div class="bx_review">
          ...
          <p>인포메이션디자인에 대해 잘 몰랐는데, 이번 수업으로 기초부터 탄탄히 잡으니 디자인이 재밌어졌다!</p>
          <div class="t_bottom">
            <div class="b_left">
        ...
        <div class="bx_review">
          ...
          <p>인포메이션디자인 수업듣고 취업 성공..<br />수업구성이 너무 알차네요^^!</p>
          <div class="t_bottom">
            <div class="b_left">
              <span class="date">{{ today.day }} {{ today.date }}</span> <br/>
            </div>
    ...
    <div class="area">
      <div class="a_top">
        <h2 class="tit">인포메이션디자인 강의와<br /><b class="txt_point_line">비슷한 강의</b>둘러보기</h2>
      </div>
