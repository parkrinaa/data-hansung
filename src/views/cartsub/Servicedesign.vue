<template>
  <div class="inner course serviceexperience">
    ...
    <div class="area">
      ...
      <div class="area_bx_review">
        <div class="bx_review">
          ...
          <p>이번 수업을 통해 서비스경험디자인에 대해 많이 깨달았음...최고 최고!! 짱짱!! 또 듣고싶습니다!</p>
          <div class="t_bottom">
            <div class="b_left">
        ...
        <div class="bx_review">
          ...
          <p>서비스경험디자인 수업듣고 취업 성공..<br />수업구성이 너무 알차네요^^!</p>
          <div class="t_bottom">
            <div class="b_left">
              <span class="date">{{ today.day }} {{ today.date }}</span> <br/>
            </div>
    ...
    <div class="area">
      <div class="a_top">
        <h2 class="tit">서비스경험디자인 강의와<br /><b class="txt_point_line">비슷한 강의</b>둘러보기</h2>
      </div>
