<template>
  <div class="inner course typography">
    <div id="btn_group">
    ...
    <div class="area">
      ...
      <div class="area_bx_review">
        <div class="bx_review">
          ...
          <p>타이포그래피로 인물 만들기 재밌었다.. 교수님도 친절하시다.. 짱짱맨이다..</p>
          <div class="t_bottom">
            <div class="b_left">
        ...
        <div class="bx_review">
          ...
          <p>타이포그래피 수업듣고 취업 성공..<br />수업구성이 너무 알차네요^^!</p>
          <div class="t_bottom">
            <div class="b_left">
              <span class="date">{{ today.day }} {{ today.date }}</span> <br/>
            </div>
    ...
    <div class="area">
      <div class="a_top">
        <h2 class="tit">타이포그래피 강의와<br /><b class="txt_point_line">비슷한 강의</b>둘러보기</h2>
      </div>
