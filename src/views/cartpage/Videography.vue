<template>
  <div class="inner course videography">
    <div id="btn_group">
    ...
    <div class="area">
      ...
      <div class="area_bx_review">
        <div class="bx_review">
          ...
          <p>영상촬영에 관심있는 사람들은<br />진짜 쏠쏠한 강의같음^^</p>
          <div class="t_bottom">
            <div class="b_left">
        ...
        <div class="bx_review">
          ...
          <p>영상촬영 스튜디오 수업듣고 취업 성공..<br />수업구성이 너무 알차네요^^!</p>
          <div class="t_bottom">
            <div class="b_left">
              <span class="date">{{ today.day }} {{ today.date }}</span> <br/>
            </div>
    ...
    <div class="area">
      <div class="a_top">
        <h2 class="tit">영상촬영 스튜디오 강의와<br /><b class="txt_point_line">비슷한 강의</b>둘러보기</h2>
      </div>
