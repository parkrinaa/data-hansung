<template>
  <div class="inner course videodesign">
    <div id="btn_group">
    ...
    <div class="area">
      ...
      <div class="area_bx_review">
        <div class="bx_review">
          ...
          <p>영상의 이응도 몰랐던 내가..<br />카메라 샀습니다...</p>
          <div class="t_bottom">
            <div class="b_left">
        ...
        <div class="bx_review">
          ...
          <p>영상디자인기초 수업듣고 취업 성공..<br />수업구성이 너무 알차네요^^!</p>
          <div class="t_bottom">
            <div class="b_left">
              <span class="date">{{ today.day }} {{ today.date }}</span> <br/>
            </div>
    ...
    <div class="area">
      <div class="a_top">
        <h2 class="tit">영상디자인기초 강의와<br /><b class="txt_point_line">비슷한 강의</b>둘러보기</h2>
      </div>
